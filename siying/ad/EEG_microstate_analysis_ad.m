...
StudyFolder = 'H:\ADstudy\EEG';
out_folder='E:\zhaoshp\MST_results\siying_MST_test';%自动生成features2文件夹存放结果
ConDir = [StudyFolder,filesep,'Preprocessed_',groups{group_index}];%数据存放路径，某一组别
...
SavePath = [out_folder,filesep,groups{group_index},filesep,'features2',filesep,'result_',conditions{group_index}];mkdir(SavePath);
ConIndex = [];
